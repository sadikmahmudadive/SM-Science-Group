...
function DashboardLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  const navItems = {
    admin: [
      ...
      { label: "Grading Center", icon: GraduationCap, href: "/annex/dashboard/grading" },
      { label: "Teacher Attendance", icon: ClipboardCheck, href: "/annex/dashboard/teacher-attendance" },
      { label: "Student Attendance", icon: Calendar, href: "/annex/dashboard/attendance" },
      { label: "Library Vault", icon: Library, href: "/annex/dashboard/library" },
      { label: "Public Staff", icon: Users, href: "/annex/dashboard/staff" },
    ...
    teacher: [
      ...
      { label: "Assignments", icon: FileText, href: "/annex/dashboard/assignments" },
      { label: "Grading Center", icon: GraduationCap, href: "/annex/dashboard/grading" },
      { label: "Student Attendance", icon: Users, href: "/annex/dashboard/attendance" },
    ...
    student: [
      ...
      { label: "Assignments", icon: FileText, href: "/annex/dashboard/assignments" },
      { label: "Attendance", icon: Calendar, href: "/annex/dashboard/attendance" },
      { label: "Library", icon: Library, href: "/annex/dashboard/library" },
    ]
